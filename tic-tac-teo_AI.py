...
def playerMove():
    ...
    while run:
        move = input("Please enter the position number between (1 to 9) to place X : ")
        try:
            move = int(move)
...
def main():
    print("Welcome to tic tac teo game by Rhutik")
    ...
    while not(isBoardFull(board)):
        if not (isWinner(board, 'O')):
            ...
            print('Sorry, Computer won this game, better luck next time!')
            break
